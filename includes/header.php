					...
					if (isset($_SESSION['user_email']) || isset($_SESSION['user_pass'])) { 
						...
						<ul class="navbar-nav" style="margin-right:30px; ">
							...
							<?php 
								...
								$query_req = "SELECT * FROM orders WHERE seller_email = '$user_email' AND confirm_status = 0 ";
									...
									if ($cnt_rw>0) { 
											...
											?>
												...
												<li class="ordr_rq">
													...
													<p><b style="color:white">Order Request</b> <span style="padding: 3px;color:black;margin-left: 3px;border: 2px solid white;border-radius: 100%;font-weight:bold;"><?php echo $cnt_rw; ?></span></p>
													</a>
												</li>
