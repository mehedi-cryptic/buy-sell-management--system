...
$total_success_order_trans = "SELECT * FROM orders WHERE confirm_status='1'";
...
$total_unsuccess_order_trans = "SELECT * FROM orders WHERE confirm_status='0'";
