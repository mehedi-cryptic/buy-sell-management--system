                    ...
                    <div class="row">
                        <div class="col-md-6" style="margin-left:20%">
                            <?php 
                                ...
                                $user_name=$fm->validation($_POST['username']);
                                ...
                                if (!empty($user_full_name_new) &&  !empty($user_name) && !empty($user_img) && !empty($user_fb_new) && !empty($user_twiter_new) && !empty($user_insta_new)) {

                                    $query = "update dashboard_user set user_full_name='$user_full_name_new',user_name='$user_name',user_img='$user_img',user_fb='$user_fb_new',user_twiter='$user_twiter_new',user_insta='$user_insta_new' where user_id = $del_pro_id_up ";
                             ...
                             ?>
                                 <form role="form" action="profile_edit.php" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" name="username" class="form-control" value="<?php echo isset($_GET['del_pro']) ? $user_name : '' ?> ">
                                    </div>
                                     <div class="form-group">
